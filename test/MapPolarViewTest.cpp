...
/*FIXFIXFIX
	...
	EXPECT_TRUE(length_range(map.at(10).get_length(), len1));
	EXPECT_TRUE(length_range(map.at(20).get_length(), len1));
	EXPECT_TRUE(length_range(map.at(30).get_length(), r2d2::Length()));
...
TEST(MapPolarView, add_distancereadingOne){
	...
	EXPECT_TRUE(length_range(map.at(0).get_length(), r2d2::Length()));
...
TEST(MapPolarView, rotate){
    ...
    for(int i = 6; i < 15; i++){
        EXPECT_TRUE(length_range(map.at(i).get_length(), r2d2::Length()));
    }
